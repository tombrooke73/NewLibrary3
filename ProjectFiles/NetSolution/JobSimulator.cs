...
public class JobSimulator : BaseNetLogic
{
    private PeriodicTask updateOvenTemperaturePeriodicTask;
    private int temperatureUpdateCounter = 0;
    private PeriodicTask periodicTask;
    IUAVariable spF1, durationF1, actualDurationF1;
    IUAVariable spF2, durationF2, actualDurationF2;
    IUAVariable spF3, durationF3, actualDurationF3;
